...
USB_ID_PRODUCT_EV3 = 0x0005
USB_ENDPOINT_IN  = 0x81
USB_ENDPOINT_OUT = 0x01


class SystemCommand:
    REPLY               = b'\x01'  # reply required
    NO_REPLY            = b'\x81'  # reply not require

    BEGIN_DOWNLOAD      = b'\x92'  # Begin file download
    CONTINUE_DOWNLOAD   = b'\x93'  # Continue file download
    BEGIN_UPLOAD        = b'\x94'  # Begin file upload
    CONTINUE_UPLOAD     = b'\x95'  # Continue file upload
    BEGIN_GETFILE       = b'\x96'  # Begin get bytes from a file (while writing to the file)
    CONTINUE_GETFILE    = b'\x97'  # Continue get byte from a file (while writing to the file)
    CLOSE_FILEHANDLE    = b'\x98'  # Close file handle
    LIST_FILES          = b'\x99'  # List files
    CONTINUE_LIST_FILES = b'\x9A'  # Continue list files
    CREATE_DIR          = b'\x9B'  # Create directory
    DELETE_FILE         = b'\x9C'  # Delete
    LIST_OPEN_HANDLES   = b'\x9D'  # List handles
    WRITEMAILBOX        = b'\x9E'  # Write to mailbox
...
class SystemReply:
    ...
    SUCCESS              = b'\x00'
    UNKNOWN_HANDLE       = b'\x01'
    HANDLE_NOT_READY     = b'\x02'
    CORRUPT_FILE         = b'\x03'
    NO_HANDLES_AVAILABLE = b'\x04'
    NO_PERMISSION        = b'\x05'
    ILLEGAL_PATH         = b'\x06'
    FILE_EXITS           = b'\x07'
    END_OF_FILE          = b'\x08'
    SIZE_ERROR           = b'\x09'
    UNKNOWN_ERROR        = b'\x0A'
    ILLEGAL_FILENAME     = b'\x0B'
    ILLEGAL_CONNECTION   = b'\x0C'
